...
//Weight for City Target if Liberation Quest Active
	...
	inline int getVASSALAGE_FREE_CULTURE_FROM_VASSAL_PERCENT()
	{
		return m_iVASSALAGE_FREE_CULTURE_FROM_VASSAL_PERCENT;
	}
	...
	inline int getVASSALAGE_VASSAL_CITY_THRESHOLD()
	{
		return m_iVASSALAGE_VASSAL_CITY_THRESHOLD;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iVASSALAGE_FREE_CULTURE_FROM_VASSAL_PERCENT;
	...
	int m_iVASSALAGE_VASSAL_CITY_THRESHOLD;
